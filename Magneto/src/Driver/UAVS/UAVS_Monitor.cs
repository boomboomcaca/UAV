...
public partial class Uavs
{
    ...
    {
        //var droneTemplates = obj as DroneModel[];
        //UavDll.InitEnhancedUavSchema(droneTemplates.Select(p => p.ToDrone()).ToArray(), (droneTemplates?.Length) ?? 0);
        while (_uavCaptureCts?.IsCancellationRequested == false)
            try
            {
                ...
                //var droneArrayStr = "1;DJI PHANTOM 3;uplink;2.4GHz;2401\n";
