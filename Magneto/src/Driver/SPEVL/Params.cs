...
[DriverDescription(FeatureType = FeatureType.SPEVL,
    Name = "频谱评估",
    ...
    MaxInstance = 5,
    Description = "频谱评估功能")]
public partial class Spevl
{
    [Parameter(IsInstallation = true, AbilitySupport = FeatureType.SPEVL)]
    ...
    [Parameter(AbilitySupport = FeatureType.SPEVL)]
    ...
    [Style(DisplayStyle.Switch)]
    [Browsable(false)]
    public bool SaveStatData { get; set; } = true;
}