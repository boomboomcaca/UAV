...
[DriverDescription(FeatureType = FeatureType.SATELS,
    Name = "卫星通信管控",
    Category = ModuleCategory.RadioSuppressing,
    Version = "1.1.0",
    Model = "SATELS",
    MaxInstance = 1,
    Description = "联合监测设备实现引导或独立的卫星通信管制功能")]
public partial class Satels
{
    ...
    [Module(NeedModule = ModuleCategory.RadioSuppressing,
        NeedFeature = FeatureType.SATELS,
        NeedEquip = true,
    ...
    [ValueRange(double.NaN, double.NaN, 100)]
    [Style(DisplayStyle.Input)]
    public new IDevice AntennaController { get; set; }
    ...
    [Parameter(AbilitySupport = FeatureType.SATELS)]
