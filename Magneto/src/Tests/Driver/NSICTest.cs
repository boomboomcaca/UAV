...
public class NsicTest
{
    ...
    private readonly string _templateId = "a018fda0-1852-11ec-b02b-053ab2c868a1";
    ...
    public void InitializeTest()
    {
        ...
        if (_nsic == null) Assert.Fail("没有NSIC驱动");
        ...
        try
        {
            ...
            _nsic.SetParameter(ParameterNames.Receiver, _device);
            _nsic.Initialized(_module);
        }
        catch (Exception ex)
        {
    ...
    public void SetScanSegmentsParameterTest()
    {
        ...
        try
        {
            ...
            segments[0] = dic;
            _segments = segments;
            _nsic.SetParameter(ParameterNames.ScanSegments, segments);
        }
        catch (Exception e)
        {
    ...
    public void SetTemplateParameterTest()
    {
        ...
        try
        {
            _nsic.SetParameter("functionSwitch", false);
            _nsic.SetParameter("templateID", _templateId);
            _nsic.SetParameter("setSimData", true);
        }
        catch (Exception e)
        {
            Assert.Fail(e.Message);
    ...
    public void StartTemplateTest()
    {
        ...
        try
        {
            ...
            _nsic.Start(_dataPort, MediaType.None);
        }
        catch (Exception e)
        {
            Assert.Fail(e.Message);
    ...
    public void SetCompareParameterTest()
    {
        ...
        try
        {
            _nsic.SetParameter("functionSwitch", true);
            _nsic.SetParameter("templateID", _templateId);
    ...
    public void StopCompareTest()
    {
        ...
        if (_isAppException) Assert.Fail(_appExeMsg);
        if (_recvDataError) Assert.Fail(_errMsg);
        if (_count == 0) Assert.Fail("比对无数据返回");
        if (_nsic == null) Assert.Fail("没有NSIC驱动");
        try
        {
            _dataPort.DataArrived -= CompareDataArrived;
