...
///     B类船舶位置数据
/// </summary>
public class AisPositionB : IAisMessage, IAisDecodable, ICloneable
{
    /// <summary>
    ///     标准B类船舶数据
    /// </summary>
    ...
    public virtual IAisMessage Decode(string decBytes)
    {
        ...
        AisDecoder.GetDecValueByBinStr(decBytes.Substring(56, 1), false);
    ...
    public override string ToString()
    {
        ...
        sbuider.Append("AISPositionB\n").Append("[").Append("MsgID:" + MsgId + "\n").Append("MMSI:" + Mmsi + "\n")
            ...
            .Append("COG:" + Cog + "\n").Append("Heading:" + TrueHeading + "\n").Append("MstTimeStamp:" + MsgTimestamp)
            .Append("]");
