...
/// <summary>
///     AISData 静态数据报告 消息ID=24
/// </summary>
public class AisStaticDataReport : IAisStaticData, IAisDecodable, ICloneable
{
    /// <summary>
    ///     静态数据报告
    /// </summary>
    ...
    public IAisMessage Decode(string decBytes)
    {
        ...
        if (PartNo == 0)
        {
            var name = AisDecoder.GetDecStringFrom6BitStr(decBytes.Substring(40, 120));
            if (!string.IsNullOrEmpty(name)) ShipName = name;
    ...
    public override bool Equals(object o)
    {
        ...
        if (o is not AisStaticDataReport that) return false;
