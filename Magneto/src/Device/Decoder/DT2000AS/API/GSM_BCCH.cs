...
{
    //public ushort CI;         // Cell identity value
    //public ushort MCC;    //Mobile country code 
    //public ushort MNC;   //Mobile network code  
    //public ushort LAC;   // Location area cod
    //public byte ATT; //ATT, Attach-detach allowed (octet 2)
    //public byte BS_AG_BLKS_RES;
    //public byte CCCH_CONF;
    //public byte BS_PA_MFRMS;
    //public byte T3212; //timeout value;
    //public byte PWRC;  //10.5.2.3 Cell Options (BCCH)
    //public byte DTX; // 10.5.2.3 Cell Options (BCCH)
    //public byte RADIO_LINK_TIMEOUT; //10.5.2.3 Cell Options (BCCH)
    //public byte Max_retrans; //Maximum number of retransmissions 10.5.2.29
    //public byte Tx_integer; //Number of slots to spread transmission 10.5.2.29
    //public byte CELL_BAR_ACCESS; //1 The cell is barred 10.5.2.29
    //public byte RE; // 1 Call Reestablishment not allowed in the cell 10.5.2.29
    //public byte AC_CN; //Access Control Class N access is not barred if the AC CN bit is coded with a "0";
    //public byte CELL_RESELECT_HYSTERESIS; //RXLEV hysteresis for LA re-selection
    //public byte MS_TXPWR_MAX_CCH; //binary representation of the "power control level"
    //public byte ACS;
    //public byte NECI; // 1 New establishment causes are  supported
    //public short RXLEV_ACCESS_MIN;  // binary representation of the minimum received signal level
    //public byte CBQ; //CELL_BAR_QUALIFY (1 bit field); 10.5.2.34 SI 3 Rest Octets
    //public byte CELL_RESELECT_OFFSET; //(6 bit field) 10.5.2.34 SI 3 Rest Octets
    //public byte TEMPORARY_OFFSET; // (3 bit field); 10.5.2.34 SI 3 Rest Octets
    //public byte PENALTY_TIME; // (5 bit field) 10.5.2.34 SI 3 Rest Octets
    //public byte Power_Offset; //10.5.2.34 SI 3 Rest Octets
    //public byte GPRS_Support; // 1 support GPRS
    //public byte RA_COLOUR;
    //public ushort C0; // main carrier 主要载体
    //                  //     public ushort[] CA;// CA[65];  // Cell Channel Description
    //[MarshalAs(UnmanagedType.ByValArray, SizeConst = 65)]
    //public ushort[] CA; //= new ushort[65];
    //                    //  public ushort []BA;//[65];  //Neighbour Cell BCCH Frequency List
    //[MarshalAs(UnmanagedType.ByValArray, SizeConst = 65)]
    //public ushort[] BA;// = new ushort[65];
    //                   //  public ushort[] extBA;//[65];  //Extended BCCH Neighbour Cell Frequency List
    //[MarshalAs(UnmanagedType.ByValArray, SizeConst = 65)]
    //public ushort[] extBA;// = new ushort[65];
    //public byte TSC;// training sequence
    //public byte BSIC; // TSC + PLMN = BSIC
    //public byte NCC;
    //public byte NCH_Position; //10.5.2.32 NCH Position on the CCCH
    //public short RSSI;
    //public byte SIB1;
    //public byte SIB2;
    //public byte SIB3;
