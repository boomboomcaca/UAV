...
public partial class Dt2000As
{
    ...
    private void ProcessGsmData()
    {
        ...
        var count = Rx3GInterface.get_one_gsm_cell(ref bcch);
        if (count < 1)
        {
            Thread.Sleep(ScanInterval);
            return;
    ...
    private void ProcessCdmaData()
    {
        ...
        var count = Rx3GInterface.get_one_cdma_cell(ref bcch);
        if (count < 1)
        {
            Thread.Sleep(ScanInterval);
            return;
    ...
    private void ProcessEvdoData()
    {
        ...
        var count = Rx3GInterface.get_one_evdo_cell(ref bcch);
        if (count < 1)
        {
            Thread.Sleep(ScanInterval);
            return;
    ...
    private void ProcessWcdmaData()
    {
        ...
        var count = Rx3GInterface.get_one_wcdma_cell(ref bcch);
        if (count < 1)
        {
            Thread.Sleep(ScanInterval);
            return;
    ...
    {
        var bcch = new UmtsBcch();
        var count = Rx3GInterface.get_one_tdscdma_cell(ref bcch);
        if (count < 1)
        {
            Thread.Sleep(ScanInterval);
            return;
    ...
    private void ProcessLteData()
    {
        ...
        var count = Rx3GInterface.get_one_lte_cell(ref bcch);
        if (count < 1)
        {
            Thread.Sleep(ScanInterval);
            return;
