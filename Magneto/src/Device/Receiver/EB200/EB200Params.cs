...
[DeviceDescription(Name = "EB200",
    ...
    Description = "R&amp;S EB200 监测接收机(20MHz~3000MHz)")]
public partial class Eb200
{
    ...
    [Parameter(AbilitySupport = FeatureType.FFM | FeatureType.IFOUT)]
    ...
    [Parameter(AbilitySupport = FeatureType.FFM | FeatureType.MScne | FeatureType.FScne | FeatureType.IFOUT)]
    [Category(PropertyCategoryNames.Measurement)]
    [DisplayName("中频带宽")]
    ...
    [Parameter(AbilitySupport = FeatureType.FFM | FeatureType.SCAN | FeatureType.FScne | FeatureType.IFOUT)]
    [Category(PropertyCategoryNames.Measurement)]
    [DisplayName("滤波带宽")]
    [Description("滤波带宽、解调带宽 默认单位 kHz")]
    [StandardValues(IsSelectOnly = true,
        StandardValues = "|150|120|50|30|15|9|6|2.4|1.5|1",
        DisplayValues = "|150kHz|120kHz|50kHz|30kHz|15kHz|9kHz|6kHz|2.4kHz|1.5kHz|1kHz")]
    [DefaultValue(150d)]
    [Unit(UnitNames.KHz)]
    [Style(DisplayStyle.Bandwidth)]
    ...
    [Description("设置扫描步进")]
    [StandardValues(IsSelectOnly = true,
        StandardValues = "|75|60|25|15|7.5|4.5|3",
        DisplayValues = "|75kHz|60kHz|25kHz|15kHz|7.5kHz|4.5kHz|3kHz")]
    [DefaultValue(25d)]
    [Unit(UnitNames.KHz)]
    ...
    [Parameter(AbilitySupport = FeatureType.FFM | FeatureType.SCAN | FeatureType.MScan | FeatureType.MScne |
                                FeatureType.FScne | FeatureType.IFOUT)]
    [Category(PropertyCategoryNames.Measurement)]
    [DisplayName("射频模式")]
    ...
    [Parameter(AbilitySupport = FeatureType.FFM | FeatureType.FScne | FeatureType.IFOUT)]
    ...
    [DisplayName("检波方式")]
    [StandardValues(IsSelectOnly = true,
        StandardValues = "|AVG|FAST|POS",
        DisplayValues = "|平均|快速|峰值")]
    [Description("设置处理电平与频谱数的检波方式。")]
    [DefaultValue(DetectMode.Pos)]
    [Children($"|{ParameterNames.MeasureTime}", DetectMode.Avg, DetectMode.Pos)]
    [Style(DisplayStyle.Radio)]
    ...
    [Parameter(AbilitySupport = FeatureType.FFM | FeatureType.SCAN | FeatureType.FScne | FeatureType.MScan)]
    [Category(PropertyCategoryNames.Measurement)]
    [DisplayName("FFT模式")]
