...
[DeviceDescription(
    ...
    FeatureType = FeatureType.FFM
                  ...
                  | FeatureType.TDOA,
    MaxInstance = 1,
    DeviceCapability = "20|8000|80000",
    Description = "应用于德辰科技自研MR3000A系列接收机")]
[DeviceDescription(
    Name = "DF3000A(1)",
    ...
    FeatureType = FeatureType.FFM
                  ...
                  | FeatureType.TDOA,
    MaxInstance = 1,
    DeviceCapability = "8000|18000|80000",
    Description = "应用于德辰科技自研DF3000A系列单通道测向机")]
[DeviceDescription(
    Name = "DF3000A(2)",
    DeviceCategory = ModuleCategory.DirectionFinding | ModuleCategory.Monitoring,
    Manufacturer = "成都阿莱夫信息技术有限公司",
    ...
    MaxInstance = 1,
    DeviceCapability = "20|8000|80000",
    Description = "应用于德辰科技自研DF3000A系列双通道测向机")]
[DeviceDescription(
    Name = "DF3000A(9)",
    DeviceCategory = ModuleCategory.DirectionFinding | ModuleCategory.Monitoring,
    Manufacturer = "成都阿莱夫信息技术有限公司",
    ...
    MaxInstance = 1,
    DeviceCapability = "20|8000|80000",
    Description = "应用于德辰科技自研DF3000A系列九通道测向机")]
public partial class Mr3000A
{
    #region 天线控制
    ...
    [StandardValues(Key = "DF3000A(1)", IsSelectOnly = true,
        StandardValues = "|ci",
        DisplayValues = "|干涉仪")]
    [StandardValues(Key = "DF3000A(2)", IsSelectOnly = true,
        StandardValues = "|ci",
        DisplayValues = "|干涉仪")]
    [StandardValues(Key = "DF3000A(9)", IsSelectOnly = true,
    ...
    [Parameter(AbilitySupport = FeatureType.FFM | FeatureType.DPX | FeatureType.ITUM | FeatureType.SCAN |
                                FeatureType.FScne | FeatureType.FFDF | FeatureType.SSE)]
    [Name(ParameterNames.FilterBandwidth)]
    [DisplayName("滤波带宽")]
    [Description("滤波带宽或解调带宽")]
    [Category(PropertyCategoryNames.Demodulation)]
    [StandardValues(IsSelectOnly = true,
        StandardValues = "|80000|40000|20000|10000|5000|2000|1000|500|300|200|150|120|100|50|20|15|12|10|5|2|1",
        DisplayValues =
            "|80MHz|40MHz|20MHz|10MHz|5MHz|2MHz|1MHz|500kHz|300kHz|200kHz|150kHz|120kHz|100kHz|50kHz|20kHz|15kHz|12kHz|10kHz|5kHz|2kHz|1kHz")]
    [DefaultValue(120.0d)]
    [Unit(UnitNames.KHz)]
    [PropertyOrder(7)]
    [Style(DisplayStyle.Bandwidth)]
    ...
    [Parameter(AbilitySupport =
        FeatureType.FFM | FeatureType.ITUM | FeatureType.FScne | FeatureType.FFDF | FeatureType.SSE)]
    ...
    [Parameter(AbilitySupport = FeatureType.FFM | FeatureType.DPX | FeatureType.ITUM | FeatureType.SCAN |
                                FeatureType.MScan
                                | FeatureType.FScne | FeatureType.MScne | FeatureType.IFMCA)]
    ...
    public int IqSamplingCount
    {
        ...
        set
        {
            ...
            SendCommand($"TDOA:COUN {value}"); //TODO; to be removed after 2020/04/01
        }
    }
    ...
    [Parameter(AbilitySupport = FeatureType.FFM | FeatureType.DPX | FeatureType.ITUM | FeatureType.FScne |
                                FeatureType.AmpDF | FeatureType.TDOA | FeatureType.SSE)]
    ...
    private bool _fixedSamplingRate;

    [Parameter(AbilitySupport = FeatureType.FFM | FeatureType.TDOA)]
    [Name("fixedSamplingRate")]
    [DisplayName("固定采样率")]
    [Description("设置是否使用固定320kHz采样率采集IQ数据，否则使用浮动采样率，采样率与采样带宽（频谱带宽）相对应")]
    [Category(PropertyCategoryNames.DataSwitch)]
    [StandardValues(IsSelectOnly = true,
        StandardValues = "|true|false",
        DisplayValues = "|开|关")]
    ...
    [PropertyOrder(26)]
    [Style(DisplayStyle.Switch)]
    public bool FixedSamplingRate
    {
        get => _fixedSamplingRate;
        set
        {
            _fixedSamplingRate = value;
            if (TaskState == TaskState.Start && (_subscribedData & DataType.Iq) > 0)
            {
                if (value)
                {
    ...
    [Parameter(IsInstallation = true, RegexPattern = @"DF3000A\S*")]
    [Name("dfChannelCount")]
    [DisplayName("测向通道数")]
    [Description("设置测向通道数")]
    ...
    [Category(PropertyCategoryNames.Configuration)]
    [StandardValues(IsSelectOnly = true, Key = "DF3000A(1)",
        StandardValues = "|false",
        DisplayValues = "|否",
        DefaultValue = false)]
    [StandardValues(IsSelectOnly = true, Key = "DF3000A(2)",
        StandardValues = "|true|false",
        DisplayValues = "|是|否",
        DefaultValue = true)]
    [StandardValues(IsSelectOnly = true, Key = "DF3000A(9)",
        StandardValues = "|true|false",
        DisplayValues = "|是|否",
        DefaultValue = true)]
    // [DefaultValue(true)]
    ...
    [Parameter(IsInstallation = true, Key = "DF3000A(2)")]
    [Name("dfAntennaRef")]
    [DisplayName("天线参考数")]
    ...
    [Name("iqSamplingTime")]
    [DisplayName("采样时间")]
    [Description("设置采样率为320kHz时，连续IQ采集时间，单位：秒")]
    [Category(PropertyCategoryNames.Configuration)]
    [ValueRange(1, 20)]
    [DefaultValue(5)]
    [PropertyOrder(41)]
    [Style(DisplayStyle.Slider)]
    public int IqSamplingTime { get; set; } = 5;
    ...
    [Parameter(IsInstallation = true, Key = "DF3000A(9)")]
    [Name("realtimeChannelCalibration")]
    [DisplayName("实时通道校准")]
    [Description("设置测向时是否启用射频通道实时校准功能")]
    [Category(PropertyCategoryNames.Configuration)]
    [StandardValues(IsSelectOnly = true,
        StandardValues = "|true|false",
        DisplayValues = "|开|关")]
    ...
    [PropertyOrder(44)]
    [Style(DisplayStyle.Switch)]
    public bool RealtimeChannelCalibration { get; set; }
