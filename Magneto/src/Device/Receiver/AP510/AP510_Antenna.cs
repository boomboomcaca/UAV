...
public partial class Ap510 : IAntennaController
{
    ...
    ///     设置当前选择的天线
    /// </summary>
    private void SetSelectedAntenna()
    {
        var info = Array.Find(_antennaTemplates, o => o.Id == AntennaId);
        CurrAntenna = info != null ? info.Name : CurrAntenna;
    }
