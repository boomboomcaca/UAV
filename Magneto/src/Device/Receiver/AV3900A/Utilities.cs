...
internal static class Utilities
{
    ...
    public static float Window(ref float[] data, SalWindowType windowType = SalWindowType.WindowHann)
    {
        ...
        switch (windowType)
        {
            case SalWindowType.WindowUniform:
                for (var i = 0; i < length; ++i) data[i] = 1;
                coe = -1;
                break;
            case SalWindowType.WindowHann:
            {
