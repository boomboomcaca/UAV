...
internal static class Consts
{
    ...
    internal static readonly Dictionary<int, int> DefaultSteps = new()
    {
        { 0, 0 },
        { 1, 1 },
        { 2, 3 },
    ...
    internal static readonly double[] ArraySpan =
    {
        ...
        1000d, 2000d, 5000d, 1000d, 20000d
    };

    internal static readonly double[] ArrayStep =
    {
        0.000625d, 0.00125d, 0.0025d, 0.003125d, 0.00625d,
        0.0125d, 0.025d, 0.03125d, 0.05d, 0.0625d, 0.1d, 0.125d,
        0.2d, 0.25d, 0.315d, 0.5d, 0.625d, 1d, 1.25d, 2d, 2.5d,
        3.125d, 5d, 6.25d, 8.333d, 10d, 12.5d, 20d, 25d, 50d,
