...
public partial class XeVuhf
{
    ...
    private void InitNetwork()
    {
        ...
        InitUdpSocket(localIp, out _udpExtractionSocket, ref UdpExtractionPort);
    }

    private void TelnetSocket_ConnectionClosed()
    {
    ...
    private void InitTasks()
    {
        ...
        _udpExtractionCaptrueCts = new CancellationTokenSource();
        _udpExtractionCaptrueTask = new Task(UdpExtractionDataCaptrueProc, _udpExtractionCaptrueCts.Token);
        _udpExtractionCaptrueTask.Start();
        //数据处理线程
    ...
    {
        var startIndex = 0;
        HardwareConfigResult info = new(recvBuffer, ref startIndex, _version);
    ...
    private void StopTasks()
    {
        ...
        Utils.CancelTask(_udpExtractionCaptrueTask, _udpExtractionCaptrueCts);
