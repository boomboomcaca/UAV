...
internal class ItuRequest
{
    ...
    public int GetSize()
    {
        return Header.GetSize() + ChannelNo.GetSize() + UdpPort.GetSize() + AntennaChargeTime.GetSize() +
               AntennaDischargeTime.GetSize() + FieldChargeTime.GetSize() + FieldDischargeTime.GetSize() +
               XdB1Threshold.GetSize() +
               XdB2Threshold.GetSize() + BetaBandThreshold.GetSize() + GammaVqmam.GetSize() + GammaVqmfm.GetSize() +
               GammaVqmpm.GetSize() + NumOfFftPoints.GetSize() + FftWindow.GetSize() + Mode.GetSize() +
               NumOfLoops.GetSize() + NumOfIntegrations.GetSize() + TypeOfIntegration.GetSize() +
               AcquisitionTime.GetSize() +
               ChannelId.GetSize();
    }
}