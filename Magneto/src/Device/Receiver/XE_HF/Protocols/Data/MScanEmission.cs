...
internal class MScanEmission
{
    ...
    {
        Emission.DataSize = GetSize() - Emission.GetSize();
    ...
    public int GetSize()
    {
        return Emission.GetSize() + Identifier.GetSize() + EmissionType.GetSize() + FMin.GetSize() +
               FMax.GetSize() + CentreFrequency.GetSize() + Bandwidth.GetSize() + Resolution.GetSize() +
               ThresholdType.GetSize() + Threshold.GetSize() + TypeOfModulation.GetSize() + Bfo.GetSize() +
               AgcType.GetSize() + RfAttenuator.GetSize() + IfAttenuator.GetSize() + AmpliConfig.GetSize() +
               FmFilter.GetSize() + Antenna.GetSize() + Sensitivity.GetSize() + Listening.GetSize() +
               IqRecord.GetSize() + WaveRecord.GetSize() + IqFlux.GetSize() + Itu.GetSize() +
               TotalDuration.GetSize() + ReloadingDuration.GetSize() + PreservationDuration.GetSize();
    }
}