...
public enum EClockOrigin
{
    ...
    /// <summary>
    ///     通过接收GPS信息更新时间
    ///     Timing data set from external GPS receiver (or option R&amp;S DDFx-IGT, Integrated GPS Module) to maintain
    ///     continuity
...
///     Selector flags: subset of data that mass data output is to be enabled for. Find more detailed information in R&amp;
///     S
///     DDFx system manuals.
/// </summary>
[Flags]
