...
internal static class MessageId
{
    ...
    public const int MreInfoPresence = 0xA7;
}
...
internal enum XeSignalReconMode
{
    Search = 0, //信号发现
    Monitor = 1, //信号监听
    DFind = 2 //测向
...
internal enum ClientConnectionState
{
    ...
    SentTestRequest,
    ReceivedTestResult,
    SentExternalSwitchConfig,
    ReceiveExternalSwitchConfig,
    ConnectionActive
}
...
{
    public readonly Stopwatch WatcherAckTime;
    public int MessageId;

    public MessageWatcher(int msgId)
    {
        MessageId = msgId;
        WatcherAckTime = new Stopwatch();
        WatcherAckTime.Start();
    }
}