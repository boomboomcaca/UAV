 ...
 * 该功能运行时不可修改参数
 */
internal class ScanDfCommand : CommandBase
{
    ...
    protected override void InitCommand(DeviceParams device)
    {
        ...
        BbRequest.Resolution.Value = device.StepFrequency * 1000; //TODO
        ...
        BbRequest.PhaseNo.Value = PhaseNo; //TODO:后续待完善
        BbRequest.MeasurementsRequested.Value = 0x00000007; //TODO:
