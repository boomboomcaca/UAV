...
internal class MScanTemplate
{
    ...
    [StandardValues(IsSelectOnly = true,
        StandardValues = "|10000|5000|2000|1000|600|300|200|150|100|50|25|12.5|8|6.25|4|3.125|1|0.6|0.3",
        DisplayValues =
            "|10MHz|5MHz|2MHz|1MHz|600kHz|300kHz|200kHz|150kHz|100kHz|50kHz|25kHz|12.5kHz|8kHz|6.25kHz|4kHz|3.125kHz|1kHz|600Hz|300Hz")]
    [DefaultValue(150d)]
    ...
    [Unit(UnitNames.DBuV)]
    [PropertyOrder(10)]
    public int MeasureThreshold { get; set; } = 20;
