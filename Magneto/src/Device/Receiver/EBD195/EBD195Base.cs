...
using Magneto.Device.EBD195.IO;
...
public partial class Ebd195
{
    ...
    {
        _client.SendCmd(Ebd195Command.CompassAverCommand + value);
    }
    ...
    {
        _client.SendCmd(Ebd195Command.FormatReturnDataCommand + value);
    }
    ...
    {
        _client.SendCmd(Ebd195Command.DdfModeCommand + value);
    }
    ...
    {
        _client.SendCmd(Ebd195Command.SetIfCommand + value);
    }
    ...
    {
        _client.SendCmd(Ebd195Command.SetRemoteCommand);
    }
    ...
    {
        _client.SendCmd(Ebd195Command.SetLocalCommand);
    }
    ...
    private void SetFreqs(double value)
    {
        try
        {
            ...
            _client.SendCmd(Ebd195Command.SetFreqCommand + value);
        }
        catch
        {
        }
    ...
    private void SetBoundWidth(byte value)
    {
        ...
        {
            //System.Threading.Thread.Sleep(200);
            _client.SendCmd(Ebd195Command.SetBwCommand + value);
        }
        catch
        {
        }
    ...
    private void SetInterTime(byte value)
    {
        ...
        {
            //System.Threading.Thread.Sleep(200);
            _client.SendCmd(Ebd195Command.SetInterTimeCommand + value);
        }
        catch
        {
        }
    ...
    private void SetSetSquelch(int value)
    {
        ...
        {
            //System.Threading.Thread.Sleep(200);
            _client.SendCmd(Ebd195Command.SetSquelchCommand + value);
        }
        catch
        {
        }
    ...
    private void ScanCompass()
    {
        while (!_thdScanCompassTokenSource.IsCancellationRequested)
        {
            try
            {
                _client.SendCmd(Ebd195Command.QuaereCompass);
            }
            catch
            {
            }
