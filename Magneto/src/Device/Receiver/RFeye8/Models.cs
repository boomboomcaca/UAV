...
internal class TimeDataInfo
{
    ...
    ///     中心频率
    /// </summary>
    public double RealFrequency { get; set; }
    ...
    ///     RF attenuation
    /// </summary>
    public int AgcAtten { get; set; }

    /// <summary>
    ///     时间戳（单位s）
    /// </summary>
    public int Utim { get; set; }
    ...
    ///     IQ数据中的I分量
    /// </summary>
    public double[] DataI { get; set; }

    /// <summary>
    ///     IQ数据中的Q分量
    /// </summary>
    public double[] DataQ { get; set; }
}
...
internal class SweepDataInfo
{
    ...
    ///     起始频率
    /// </summary>
    public double RealStartFrequency { get; set; }

    /// <summary>
    ///     结束频率
    /// </summary>
    public double RealStopFrequency { get; set; }

    /// <summary>
    ///     分辨率带宽
    /// </summary>
    public int RealResBwHz { get; set; }
...
internal class DemodDataInfo
{
    ...
    ///     音频数据
    /// </summary>
    public byte[] DataAudio { get; set; }

    /// <summary>
    ///     以RadioTuneFreqMHz为中心频率的20M带宽的频谱数据
    /// </summary>
    public long[] DataSpec { get; set; }
}
