...
const utils = {
  ...
  normalizeDeclarations: (ast) => {
    ...
    for (
      let declarationIndex = 0; declarationIndex < ast.declarations.length; declarationIndex++
    ) {
      ...
      if (
        ...
        for (
          let propertyIndex = 0; propertyIndex < properties.length; propertyIndex++
        ) {
          ...
          if (
            ...
            for (
              let subPropertyIndex = 0; subPropertyIndex < property.value.properties.length; subPropertyIndex++
            ) {
            ...
            normalizedDeclarations.push({
              ...
              id: {
                type: "Identifier",
                name: property.value && property.value.name ?
                  property.value.name :
                  property.key.name,
              },
              init: {
        ...
        for (
          let elementIndex = 0; elementIndex < elements.length; elementIndex++
        ) {
