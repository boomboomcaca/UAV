...
import uavWhiteImage from "../../assets/uav_wl.png";
import uavWhiteImageSel from "../../assets/uav_sel_wl.png";
import pilotWhite from "../../assets/uav_pilot_wl.png";
...
const mapImageIds = {
  ...
  pilot_image_wl: "pilot_image_wl",
  uavImageId_wl: "uavImageId_wl",
  uavImageIdSel_wl: "uavImageId_sel_wl",
};
...
const loadImages = (map) => {
  [
    ...
    { id: mapImageIds.uavImageId_wl, url: uavWhiteImage },
    { id: mapImageIds.uavImageIdSel_wl, url: uavWhiteImageSel },
    { id: mapImageIds.pilot_image_wl, url: pilotWhite },
  ].forEach((item) => {
