...
class drawPlanes {
  ...
  #drawPlaneSymbol = (datas) => {
    ...
    const features = datas.map((item) => {
      ...
      let typeIcon = item.type;
      if (this.selectedPlane === item.id) {
        typeIcon = `${item.type}_sel`;
      }
      if (item.type === "uav") {
        if (item.isWhite) {
          typeIcon = `${typeIcon}_wl`;
        }
      }
      return {
        type: "Feature",
      ...
      this.map.addLayer({
        ...
        layout: {
          "icon-image": [
            ...
            "uav_wl",
            mapImageIds.uavImageId_wl,
            "uav_sel",
            mapImageIds.uavImageIdSel,
            "uav_sel_wl",
            mapImageIds.uavImageIdSel_wl,
            "fighter",
      ...
      this.map.addLayer({
        ...
        layout: {
          "icon-image": [
            ...
            ["get", "isWhite"],
            "true",
            mapImageIds.pilot_image_wl,
            mapImageIds.pilot_image,
          ],
