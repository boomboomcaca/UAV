...
const Threshold = (props) => {
  const { onDragThreshold, thrLineTop, dragLimit, threshold } = props;
  ...
  return (
    <div
      ...
      onTouchMove={(e) => {
        if (domRectRef.current && dragging) {
          ...
          console.log("touch thr top:::", touch);
    ...
    >
      <div
        ...
        style={{ top: `calc(${lineTop}% - 20px)` }}
      >
        {(dragReady || dragging) && <span>{threshold}</span>}
        <div
