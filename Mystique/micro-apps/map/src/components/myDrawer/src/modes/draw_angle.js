...
DrawLineString.clickAnywhere = function(state, e) {
  ...
  // 应该是等 currentVertexPosition到了第三次就结束测量
...
DrawLineString.onStop = function(state) {
  ...
  if (state.line.isValid()) {
    state.line.setProperty('isAngle', true);
    const angleFeatures = state.line.toGeoJSON();
    console.logangleFeatures;
