...
const Select = (props) => {
  const { className, value, name, onChange, clickStop, style, disabled } = props;
  let { children } = props;
  ...
  return (
    ...
    >
      ...
      <div className={styles.text} onClick={openOption}>
        {currentLabel}
      </div>
      <div className={styles.ab_arrow} onClick={openOption}>
        {dropIcon(open ? 180 : 0)}
      </div>
